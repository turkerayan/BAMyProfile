...
namespace BAMyProfileApp.WebApi.Validations.Student
{
    public class StudentCreateDTOValidator : AbstractValidator<StudentCreateDTO>
    {
        ...
        public StudentCreateDTOValidator(IStringLocalizer<MessageResources>localizer)
        {
            ...
            RuleFor(x => x.IsCandidate);
                    //.NotEmpty().WithMessage(_localizer[Messages.IsCandidateIsRequired]);
        }
    }
