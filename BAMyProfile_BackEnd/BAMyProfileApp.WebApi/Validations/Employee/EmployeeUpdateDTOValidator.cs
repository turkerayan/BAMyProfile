...
namespace BAMyProfileApp.WebApi.Validations.Employee
{
    public class EmployeeUpdateDTOValidator : AbstractValidator<EmployeeUpdateDTO>
    {
        ...
        public EmployeeUpdateDTOValidator(IStringLocalizer<MessageResources> localizer)
        {
            _localizer = localizer;
            RuleFor(dto => dto.Id).NotEmpty().WithMessage(_localizer["EmployeeIdRequired"]).NotNull();
