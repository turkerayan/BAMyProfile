...
namespace BAMyProfileApp.WebApi.Validations.Reference
{
    public class ReferenceUpdateDTOValidator : AbstractValidator<ReferenceUpdateDTO>
    {
        ...
        public ReferenceUpdateDTOValidator(IStringLocalizer<MessageResources> localizer)
        {
            _localizer = localizer;
            RuleFor(dto => dto.Id).NotEmpty().WithMessage(_localizer["ReferenceIdNotEmpty"]);
            ...
            .NotEmpty().WithMessage(_localizer["ReferenceAdressCannotBeLeftBlank"])
