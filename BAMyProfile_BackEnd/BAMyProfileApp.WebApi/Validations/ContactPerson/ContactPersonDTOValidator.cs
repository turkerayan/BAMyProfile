...
using BAMyProfileApp.Business.Profiles;
...
{
    public class ContactPersonDTOValidator : AbstractValidator<ContactPersonCreateDto>
    {
        private readonly IStringLocalizer<MessageResources> _localizer;

        public ContactPersonDTOValidator(IStringLocalizer<MessageResources> localizer)
        {
