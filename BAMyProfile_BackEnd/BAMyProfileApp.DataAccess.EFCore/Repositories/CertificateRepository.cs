...
public class CertificateRepository : EFBaseRepository<Certificate>, ICertificateRepository
{
    public CertificateRepository(BAMyProfileAppDbContext context) : base(context)
    {
    }
}
