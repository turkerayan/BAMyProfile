...
public class ReferenceStudentRepository : EFBaseRepository<ReferenceStudent>, IReferenceStudentRepository
{
    public ReferenceStudentRepository(BAMyProfileAppDbContext context) : base(context)
    {
    }
}
