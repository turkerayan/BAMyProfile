...
public class ExperienceRepository : EFBaseRepository<Experience>, IExperienceRepository
{
    public ExperienceRepository(BAMyProfileAppDbContext context) : base(context)
    {
