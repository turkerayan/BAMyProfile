...
public class TrainingProgramRepository : EFBaseRepository<TrainingProgram>, ITrainingProgramRepository
{
    public TrainingProgramRepository(BAMyProfileAppDbContext context) : base(context)
    {
