...
public class EventStudentRepository : EFBaseRepository<EventStudent>, IEventStudentRepository
{
    public EventStudentRepository(BAMyProfileAppDbContext context) : base(context)
    {
