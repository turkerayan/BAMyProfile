...
public class CapabilityRepository : EFBaseRepository<Capability>, ICapabilityRepository
{
    public CapabilityRepository(BAMyProfileAppDbContext context) : base(context)
    {
