...
public class LanguagesRepository : EFBaseRepository<Languages>, ILanguagesRepository
{
    public LanguagesRepository(BAMyProfileAppDbContext context) : base(context)
    {
