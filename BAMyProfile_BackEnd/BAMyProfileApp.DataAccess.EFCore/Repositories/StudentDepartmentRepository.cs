...
public class StudentDepartmentRepository : EFBaseRepository<StudentDepartment>, IStudentDepartmentRepository
{
    public StudentDepartmentRepository(BAMyProfileAppDbContext context) : base(context)
    {
