...
public class CapabilityStudentRepository : EFBaseRepository<CapabilityStudent>, ICapabilityStudentRepository
{
    public CapabilityStudentRepository(BAMyProfileAppDbContext context) : base(context)
    {
