...
{
	public class ApplicationInterviewRepository : EFBaseRepository<ApplicationInterview>, IApplicationInterviewRepository
	{
		public ApplicationInterviewRepository(BAMyProfileAppDbContext context) : base(context)
		{
