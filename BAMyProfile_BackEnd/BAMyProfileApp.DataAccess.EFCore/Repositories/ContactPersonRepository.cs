...
{
    public class ContactPersonRepository : EFBaseRepository<ContactPerson>,IContactPersonRepository
    {
        public ContactPersonRepository(BAMyProfileAppDbContext context) : base(context)
        {
        }
    }
}
