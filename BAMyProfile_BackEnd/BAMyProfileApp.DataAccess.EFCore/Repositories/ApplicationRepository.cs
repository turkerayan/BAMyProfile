...
{
    public class ApplicationRepository : EFBaseRepository<Application>, IApplicationRepository
    {
        public ApplicationRepository(BAMyProfileAppDbContext context) : base(context)
        {
