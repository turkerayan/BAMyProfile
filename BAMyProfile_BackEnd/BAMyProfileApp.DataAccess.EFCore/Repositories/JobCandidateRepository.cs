...
{
    public class JobCandidateRepository : EFBaseRepository<JobCandidate>, IJobCandidateRepository
    {
        public JobCandidateRepository(BAMyProfileAppDbContext context) : base(context)
        {
