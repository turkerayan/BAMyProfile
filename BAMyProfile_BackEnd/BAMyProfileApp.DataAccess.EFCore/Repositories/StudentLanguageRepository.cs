...
public class StudentLanguageRepository : EFBaseRepository<StudentLanguage>, IStudentLanguageRepository
{
    public StudentLanguageRepository(BAMyProfileAppDbContext context) : base(context)
    {
