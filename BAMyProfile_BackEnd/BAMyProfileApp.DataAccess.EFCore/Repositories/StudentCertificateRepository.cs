...
public class StudentCertificateRepository : EFBaseRepository<StudentCertificate>, IStudentCertificateRepository
{
    public StudentCertificateRepository(BAMyProfileAppDbContext context) : base(context)
    {
